...
const encodeCustom = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz{}"
...
var CustomEncoding = NewEncoding(encodeCustom)

var RawCustomEncoding = CustomEncoding.WithPadding(NoPadding)
